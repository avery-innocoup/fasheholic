...
if(!isset(
$_REQUEST['banner_image_base64'],
$_REQUEST['banner_image_name']
)) {
	$errorid = 3;
...
if($errorid == 0) {
	$banner_image_base64 = $_REQUEST['banner_image_base64'];
	$banner_image_name = clear_sql_inj($_REQUEST['banner_image_name'], $link);
	if(
	($banner_image_base64 == '') ||
	($banner_image_name == '')
	) {
