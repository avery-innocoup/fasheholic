...
if($errorid == 0) {
	$shop_name = clear_sql_inj($_REQUEST['shop_name'], $link);
	$shop_country = clear_sql_inj($_REQUEST['shop_country'], $link);
	$shop_url = clear_sql_inj($_REQUEST['shop_url'], $link);
