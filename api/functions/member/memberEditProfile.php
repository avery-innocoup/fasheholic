...
if(!isset(
$_REQUEST['member_email'],
$_REQUEST['member_name'],
$_REQUEST['member_username'],
$_REQUEST['member_desc']
// $_REQUEST['member_image_base64'],
// $_REQUEST['member_image_name']
)) {
	$errorid = 3;
...
if($errorid == 0) {
	$member_email = clear_sql_inj($_REQUEST['member_email'], $link);
	$member_name = clear_sql_inj($_REQUEST['member_name'], $link);
	$member_username = clear_sql_inj($_REQUEST['member_username'], $link);
	$member_desc = clear_sql_inj($_REQUEST['member_desc'], $link);
	$member_image_base64 = $_REQUEST['member_image_base64'];
	$member_image_name = clear_sql_inj($_REQUEST['member_image_name'], $link);
